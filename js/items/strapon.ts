...
let plainStrapon = new ItemToy("strapon0", "Plain strap-on", ItemSubtype.StrapOn);
...
let largeStrapon = new ItemToy("strapon1", "Large strap-on", ItemSubtype.StrapOn);
...
let equineStrapon = new ItemToy("strapon2", "Equine strap-on", ItemSubtype.StrapOn);
...
let canidStrapon = new ItemToy("strapon3", "Canid strap-on", ItemSubtype.StrapOn);
...
let chimeraStrapon = new ItemToy("strapon4", "Chimera strap-on", ItemSubtype.StrapOn);
