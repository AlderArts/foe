...
Items.Weapons.JewelledMageblade = new Item("swrd4", "J.Mageblade", ItemType.Weapon);
Items.Weapons.JewelledMageblade.price = 1500;
Items.Weapons.JewelledMageblade.sDesc = function() { return "jewelled mageblade"; }
Items.Weapons.JewelledMageblade.lDesc = function() { return "a short sword with rubies inlaid in the crossguard"; }
Items.Weapons.JewelledMageblade.Short = function() { return "Jewelled mageblade"; }
Items.Weapons.JewelledMageblade.Long = function() { return "A short sword with rubies inlaid in the crossguard. Brief concentration on the part of the wielder causes the edge to erupt in flame."; }
Items.Weapons.JewelledMageblade.effect.atkMod = 0.5;
Items.Weapons.JewelledMageblade.effect.maxSp = 100;
Items.Weapons.JewelledMageblade.effect.intelligence = 7;
Items.Weapons.JewelledMageblade.effect.spirit = 3;
Items.Weapons.JewelledMageblade.effect.apSlash = 1;
Items.Weapons.JewelledMageblade.effect.amFire = 0.5;
