...
Items.Toys.SmallDildo.Long  = function() { return "About fifteen cm in length, the pleasure toy could be used by just about anyone. It is made from a slightly rubbery material."; }
...
Items.Toys.MediumDildo.Long  = function() { return "About twentyfive cm in length, the pleasure toy is made for more advanced practitioners. It is made from a slightly rubbery material."; }
...
Items.Toys.LargeDildo.Long  = function() { return "About forty cm in length, the pleasure toy is only for the most spacious orifices. It is made from a slightly rubbery material."; }
...
Items.Toys.ThinDildo.Long  = function() { return "This dildo is about twenty cm in length, but relatively thin. It is made from a slightly rubbery material."; }
...
Items.Toys.EquineDildo.Long  = function() { return "About fifty cm in length, the pleasure toy is only for the most spacious orifices. It comes complete with a sheath and a flared head. It is made from a slightly rubbery material."; }
...
Items.Toys.CanidDildo.Long  = function() { return "About thirty cm in length, the pleasure toy is only for the most spacious orifices. It comes complete with a thick knot. It is made from a slightly rubbery material."; }
...
Items.Toys.ChimeraDildo.Long  = function() { return "About sixty cm in length, the pleasure toy is only for the most spacious orifices. It combines the barbed head of a feline cock with the sheath of a horse and the knot of a canine. It is made from a slightly rubbery material."; }
