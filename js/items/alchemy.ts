...
let equinium = new TFItem("equin0", "Equinium");
equinium.price = 7;
...
let leporine = new TFItem("lago0", "Leporine");
leporine.price = 7;
...
let felinix = new TFItem("felin0", "Felinix");
felinix.price = 7;
...
let lacertium = new TFItem("rept0", "Lacertium");
lacertium.price = 8;
...
let ovis = new TFItem("ovis0", "Ovis");
ovis.price = 8;
...
let bovia = new TFItem("bov0", "Bovia");
bovia.price = 8;
...
let caprinium = new TFItem("goat0", "Caprinium");
caprinium.price = 8;
...
let canis = new TFItem("dog0", "Canis");
canis.price = 8;
...
let lobos = new TFItem("wolf0", "Lobos");
lobos.price = 8;
...
let vulpinix = new TFItem("fox0", "Vulpinix");
vulpinix.price = 8;
...
let infernum = new TFItem("demon0", "Infernum");
infernum.price = 15;
...
let avia = new TFItem("avian0", "Avia");
avia.price = 25;
...
let lepida = new TFItem("moth0", "Lepida");
lepida.price = 10;
...
let scorpius = new TFItem("scorp0", "Scorpius");
scorpius.price = 10;
...
let cerventine = new TFItem("deer0", "Cerventine");
cerventine.price = 10;
...
let honeyBrew = new TFItem("bee0", "Honey brew");
honeyBrew.price = 10;
...
let florium = new TFItem("plant0", "Florium");
florium.price = 10;
...
let homos = new TFItem("human0", "Homos");
homos.price = 25;
...
let virilium = new TFItem("sex0", "Virilium");
virilium.price = 100;
...
let testos = new TFItem("sex2", "Testos");
testos.price = 100;
...
let estros = new TFItem("sex3", "Estros");
estros.price = 100;
...
let infertilium = new TFItem("sex4", "Infertilium");
...
let infertiliumPlus = new TFItem("sex5", "Infertilium+");
...
let fertiliumPlus = new TFItem("sex7", "Fertilium+");
...
let gestarium = new TFItem("preg0", "Gestarium");
gestarium.price = 50;
...
let gestariumPlus = new TFItem("sex1", "Gestarium+");
