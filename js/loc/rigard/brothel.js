...
Scenes.Brothel.MStrap = function() {
	...
	if(num < 10) {
		...
		Text.NL();
		Text.Add("You find yourself leaning against the bed as you recover, panting for breath. When your [legs] stop trembling, you carelessly drop the fake cock on the bed and start gingerly pulling your [botarmor] back on.", parse);
		Text.NL();
