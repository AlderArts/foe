...
LBScenes.OrvinTalkPrompt = (innPrompt: any) => {
	const rigard = GAME().rigard;
...
LBScenes.EfriPrompt = () => {
	...
	const task = LBScenes.efriaction;
...
LBScenes.DrinksPrompt = (innPrompt: any) => {
	const rigard = GAME().rigard;
	const player = GAME().player;
...
LBScenes.RandomRoom = (companion?: Entity) => {
	const rigard = GAME().rigard;
	const room69 = GAME().room69;
...
LBScenes.RegularRoom = (companion: Entity) => {
	const rigard = GAME().rigard;
	const party: Party = GAME().party;
