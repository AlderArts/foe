...
const NobleScenes: any = {};

//
// Castle: Grounds
//
CastleLoc.Grounds.description = () => {
...
CastleLoc.Grounds.enc.AddEnc(() => RigardScenes.Chatter2);
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.Parkland);
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.JeannesTower, 1.0, () => GlobalScenes.MetJeanne());
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.TheDistrict);
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.MeetingMajid, 1.0, () => {
	const rigard = GAME().rigard;
	return !GlobalScenes.PortalsOpen() && !(rigard.flags.Nobles & RigardFlags.Nobles.MetMajid);
});
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.GuardPatrol, 1.0, () => !WorldTime().IsDay());
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.AlmsForThePoor, 1.0, () => {
	const rigard = GAME().rigard;
...
CastleLoc.Grounds.enc.AddEnc(() => NobleScenes.Buns, 1.0, () => WorldTime().IsDay());

CastleLoc.Grounds.onEntry = () => {
	if (Math.random() < 0.2) {
...
NobleScenes.PalaceParade = () => {
	...
	const first = !(rigard.flags.Nobles & RigardFlags.Nobles.Parade);
...
NobleScenes.Buns = () => {
	...
	const first = !(rigard.flags.Nobles & RigardFlags.Nobles.Buns);
