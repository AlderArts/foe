...
Scenes.Mothgirl.LoneEnc = function() {
	...
	enc.onEncounter = function() {
		...
		if(Mothgirl.Met()) {
			...
			Text.NL();
			Text.Add("Now that it's stopped, you can finally get a good look at her. And what a her it is! A curvy woman flutters before you, human at first glance save the delicate pink wings beating behind her. Her limbs and the collar of her neck are covered in a downy white fuzz, however, as thick as wool by the looks of it. Beyond the whiteness, though, she's half bare: a pair of leather breeches cling tightly to her long legs, armored with hardened leather half-greaves, and crossing chains of gold coins and gemstones hang from her belt, dangling between her legs.", parse);
			Text.NL();
		...
		options.push({ nameStr : "Fight Her",
			func : function() {
				...
				Text.Clear();
				Text.Add("You ready yourself for combat! The moth-girl sighs and swings her claymore into a guarded pose, saying <i>“Tsk, you just have to do it the hard way, don't you? Oh, well… on guard!”</i>", parse);
				Text.Flush();
		...
		options.push({ nameStr : "Trade Sex",
			func : function() {
				...
				Text.Add("<i>“I don't have any money on me!”</i> you [admitLie], lowering your [weapon] to draw her eye from your [flaccidBurgeoning] coin purse. You twist your lips into a sly grin, dropping your [weapon] and your [armor] in one swift stroke. <i>“But maybe we can still make a deal…”</i>", parse);
				Text.NL();
				var gen = "";
				if(player.FirstCock())
				...
				Text.Add("The moth-girl thief considers your offer for a moment, eyes hungrily scouring your bared body, lingering on [gen]. By the way her big, pink nipples start to stiffen, she obviously likes what she sees. The moth-girl sheaths her blade, licking her lips as you approach. <i>“Well, aren't you the eager one? Tsk, well, if I can't get any coin out of you... I might as well get a good fuck out of it.”</i>", parse);
				Text.NL();
...
Scenes.Mothgirl.WinTitfuck = function(enc) {
	...
	Text.Clear();
	Text.Add("As you consider what to do with the brazen moth, your eyes are constantly drawn down to the full swells of her hefty F-cups, heaving with her quickening breath. Her pink teats are nice and stiff already, so close that she shivers with sensation as the prominent tips brush against your clothes at your slightest movement. You grab the moth-girl's slender shoulder, pulling her tight against you, feeling her soft tits press against your [breasts]. She gives a little gasp of surprise, trying to pull back, but you hold her firmly in place, cupping one of those succulent orbs and bringing its teat to your mouth.", parse);
	Text.NL();
	Text.Add("All her resistance turns to dust when your [tongue] flicks across the pale cherry point, and you grin as she gives a pitiful squeal of pleasure. You caress her teat with your talented tongue, lapping across the rough, hard circle of its edge before planting a sucking kiss on the inverted promontory, rolling it between your teeth with just enough pressure to make her gasp and moan. Slowly but surely, her reversed tip peeks out from its hiding spot, rising to the tip of your tongue.", parse);
	Text.NL();
	Text.Add("She's already putty in your hands, legs trembling and heart racing as you tease her nipples. You let your hand snake up, squeezing and caressing her soft flesh as it travels upward. You know what you want, now; and if she's half as sensitive as she seems, the wanton little moth might even like it, too. You take her by the shoulder, and she puts up little resistance as you push her down to her knees. You pull off your [armor], revealing the swell of your [cocks] as [itThey] flop[notS] onto her face. She recoils, trying to twist out of your grasp, but your strong fingers hold her fast on her knees, cock[s] resting hot on her cheek and twitching with your mounting excitement.", parse);
	Text.NL();
	parse["num"] = player.NumCocks() > 1 ? "one of" : "the";
	Text.Add("<i>“Ugh! Get [itThem] off!”</i> she cries, turning up her nose at your turgid meat. Instead, you shift your hips and push [num] tip[s] up to kiss her thin lips. Her protestations turn to a gurgling yelp as you plunge in, ramming your rod right into her mouth. Helpless to do anything else, the moth tries to scowl at you, but the effect is utterly lost with your [cock] shoved in her face. You lace your fingers through her thick white locks, pulling her down on your rod, loving every second of her long tongue coiling and lashing in her mouth, slathering your prick with hot, sticky spit. She chokes a bit at first, but she soon masters her gag reflex, letting your rigid rod glide down her throat; it looks like she's finally getting used to the idea!", parse);
	Text.NL();
	parse["c"] = hugecock ? " and convulsing throat" : "";
	Text.Add("Your body convulses with pleasure as the moth's prehensile tongue wraps around your wang, squeezing your slick schlong like a whore's practiced cunt. Pressure builds in your loins as the moth-girl milks your [cock] with her wonderful tongue[c]. As she sucks you off, you let your hands play down her largely lithe, supple frame, slipping down her slender arms to her flat belly, then up again the her big, bouncing breasts, cupping a full, fleshy orb in either hand.", parse);
	Text.NL();
	...
	Text.NL();
	Text.Add("You give the moth-girl a little push, grinning as her bountiful bust jiggles enticingly as she flops onto her back. She grabs her tits and spreads her legs for you, making it hard to resist just ripping her pants off and slamming yourself home in her hot, tight embrace - she really wants it now! But that inviting snatch is not quite what you're after.... You straddle her big hips, pumping your shaft as you loom over the defeated moth. She turns her cheek sharply aside, but the flush of arousal on her pale flesh betrays her true lust. Placing your hands on hers, you spread her tits so that they form an inviting valley just the right size to admit the shaft of your [cock], still dripping with her saliva.", parse);
	Text.NL();
	parse["c"] = hugecock ? ", slapping her right in the chin with your huge dong" : "";
	Text.Add("It slides easily between her heaving breasts, making the little moth shudder with anticipation as the spit-slick rod glides across her bare flesh. A little gasp escapes the thief's lips as your prick comes to rest in her cleavage, and you look aside to see her slender fingers roughly squeezing and pinching her flush nipples; she's the one to squeeze her tits tightly around your cock, enveloping it in a tight, hot vice of wet boobflesh that quakes with her every bated breath. You take a brief moment to enjoy the sensation of her quivering flesh rubbing along your engorged shaft before you lock your fingers over the moth's and give a powerful thrust right into the underside of her boobs[c]!", parse);
	Text.NL();
	Text.Add("The moth lets out a low, husky moan as you start to thrust into her cleavage, humping away at her tight-pressed tits. The sensation is sublime, feeling your [cock] glide through the warm embrace of her boobs, squeezing you just as good as any pussy. And the moth-girl seems to enjoy it too, breathing harder as your hips slap wetly against her tits, moaning louder with every thrust until you feel her hands moving beneath yours, moving her tits to meet your hammering [hips], thrusting them back against you to redouble your pleasure and hers.", parse);
	Text.NL();
	Text.Add("She gives an almost giddy gasp as a thick pool of pre drools from the slit of your [cock] and onto her flesh, a hot drop of musky ejaculate that draws out a primal lust from the moth: the next drop lands on the tip of her longue, insectile tongue. Before you know it, the moth's got the crown of your cock utterly wrapped in her tongue, sucking up every drop of pre she can get as she relentlessly titfucks you. She's moving faster and faster in a desperate fervor, practically begging for your cum. You're inclined to give her what she wants, feeling the mounting pressure in your [balls] as the lusty bug milks your cock for everything it's worth.", parse);
	Text.NL();
	...
	Text.NL();
	Text.Add("The desperate, greedy look she gives you over her bouncing breasts is the last straw. You grit your teeth, trying not to cry out as you feel your [cock] swelling with seed, surging toward the sluttly bug. She gives a little scream of surprise as the first hot, salty load shoots her straight in the face, splattering over her writhing tongue and agape lips. She coughs and tries to turn aside, but her tongue's trapped between her tits, pinning her face in the perfect angle for a full-bore facial. You slap her tits together as hard as you can as you give your final, climactic thrusts through the crack of her cleavage, chest heaving with exertion and ecstasy as you glaze the moth-girl's face and tits with cum.", parse);
	Text.NL();
	
	var cum = player.OrgasmCum();
	
	Text.Add("<i>“Oh, goddess,”</i> the moth-girl breathes as your last hot, sticky squirt of cum plasters on her chin.", parse);
	Text.NL();
...
Scenes.Mothgirl.WinAnal = function(enc, cocksInAss) {
	...
	Text.Clear();
	Text.Add("A wicked thought crosses your mind as you survey the curvaceous little moth. She blinks at you, still stunned, until she realizes where your gaze is going. Though held firmly in your hand, she manages to shift ever so slightly to emphasize the hefty swells of her breasts and the big cherry-pink nipples almost pressing into your [armor]. You give her a teasing smile and grab one of them, running the puffy pink areola between your fingers until her inverted teat starts to peek out. The moth blushes and chews her lip, trying to hold back a gasp of pleasure as you molest her breast.", parse);
	Text.NL();
	Text.Add("Your other hand releases her, making her beat her pretty pink wings a few times as she settles on the ground. You don't doubt she could have escaped in that moment, flown off out of your grasp - but if her little whimpers of pleasure are any indication, the thought never even crossed her mind. As a reward, you let your free hand slip up, brushing along the moth's cheek up and toward one of the tall, floppy purple feelers sprouting from her brow. If you thought she was whimper before, she redoubles the moment your fingers brush the delicate, silk-like plumes, sending shivers of ecstasy trembling down her buxom body.", parse);
	Text.NL();
	...
	Text.NL();
	Text.Add("<i>“Aw, and I was lookin' forward to a good old fashioned titfucking,”</i> the moth girl pouts. Nevertheless, she wiggles her hips as you circle around her, teasing <i>“But a good, hard fuck is fine too...”</i>", parse);
	Text.NL();
	...
	Text.Add("Beneath you, the moth-girl grunts and groans, digging her fingers into the forest dirt. Her big breasts press into the ground, seeming to bear more of her weight than her arms on their lush curves, and her wings flick and flutter unconsciously in response to your anal invasion. A few slow thrusts later, though, and she manages to relax herself, finally getting used to the feeling of your [cock] in her butt. The more she relaxes, the faster you move, picking up the pace until you're slamming your [hips] in the moth's plush behind, making her ass bounce to the beat of you fucking her her. ", parse);
	Text.NL();
	...
	if(strapon)
		Text.Add("You grit your teeth and pump your hips as you bring yourself to orgasm at the moth's expense, hammering your strapon deep into her one last time.", parse);
	else if(cocksInAss.length > 1)
		Text.Add("You blast a thick, creamy double nut deep in the moth-girl's pussy and ass at once, filling both her holes with your spooge until it's drooling out around your pistoling members.", parse);
	else
...
Scenes.Mothgirl.Loss = function(enc, traded) {
	...
	scenes.AddEnc(function() { // PC eats her out
		...
		Text.NL();
		Text.Add("Finally, you manage to get your head above the jiggling waves of titflesh - just in time for the moth to straddle your [legs], leaning in to push you back. You give a little gasp as she shoves you back against a nearby tree, grabbing your hair at the last moment to keep you from hitting it against the hard bark... only to bury it back in her cleavage again. <i>“Mmm, that's a good slut,”</i> she teases, reaching down to grab your [butt]. <i>“Keep it up!”</i>", parse);
		Text.NL();
		Text.Add("You groan your protestations, but can't deny the warm, welcoming embrace of the moth's prodigious bust. No longer truly trapped, you relax yourself in her boob-filled embrace, letting your hands wander up along her obviously-sensitive undersides, cupping and squeezing her tits until the moth's moaning in pleasure. <i>“Juuuust like that,”</i> she purrs, stroking your [hair] and gently pushing you deeper into her tits. You respond with a shake of your head, sending ripples through her jiggly boobs as your fingers fight their way upwards to pinch her pink peaks, wringing them just enough to elicit a gasp of pained pleasure from the lusty moth.", parse);
		Text.NL();
		Text.Add("The hand in your hair pulls you up, pushing you back against the tree; the moth lunges forward, pressing her lips to yours and pinning your hands between your [breasts] and her oversized tits, leaving you helpless but to caress her prominent nipples as you kiss her back, yielding as her long tongue demands entrance to your mouth. She maintains the kiss for but a moment, just long enough to let her tongue tease your tonsils before breaking it, lips trailing affectionate kisses down your neck and shoulders, rewarding your every pinch and caress of her breasts with a brush of her lips against your [skin] as her own hands work to strip you out of your [armor]. Eventually, her busy fingers make their way down to your crotch and ", parse);
		parse["l"] = player.LowerBodyType() != LowerBodyType.Single ? Text.Parse("between your [legs]", parse) : "in your crotch";
		if(player.FirstCock() && player.FirstVag())
		...
		Text.NL();
		Text.Add("<i>“Like that?”</i> she teases, fingers working faster on your sex. <i>“I think it likes me...”</i>", parse);
		Text.NL();
	...
	scenes.AddEnc(function() {
		...
		Text.Add("<i>“Mmm, hard already, huh? What's got you going so fast, the thought of me being on top and riding you into the ground 'till you're begging for more... or are you just such a boobs-[guygirl] that you get a great big hardon just from looking at these?”</i> she teases, hefting her prodigious bosom up with both hands, close enough you could reach out and lick them.", parse);
		Text.NL();
		...
		Text.Add("Waves of pleasure wash over you, or through you, as the moth-girl starts to suck you off. Again, despite her victorious stance, she seems more than willing to let you guide her through it, your hand controlling the pace and tempo of her movements up and down your shaft. Her tongue writhes around and constricts your [cock], alternating pressure and wet, sliding movements while her lips bob from crown to base, sucking you off around her over-long appendage. The sensation is alien - and totally overwhelming. Your fingers dig into the moth's silky white hair, trying desperately to find purchase. Your [legs] squirm[LnotS] madly, wracked with over-stimulation, trying desperately to keep you from cumming. ", parse);
		Text.NL();
		...
		Text.Add(". Once she's planted on you, though, it doesn't take long for the moth-girl to start moving, alternatively bouncing and grinding in your lap, mashing her boobs in your face until they completely black out your world.", parse);
		Text.NL();
		Text.Add("Your captor giggles and wiggles her shoulders, sending quakes of boobflesh slapping against your cheeks. Swallowed in warm, wet darkness, all you can do is clutch at the moth's body in a desperate attempt to hold her back. But, blind and wracked by waves of pleasure, you're completely ineffectual - left utterly at the moth-girl's mercy as she bounces on your cock. Your fingers find some purchase on the soft swells of her ass cheeks and you dig into them, squeezing and kneading the bandit's butt until she squeals with pleasure, moving faster in response.", parse);
		Text.NL();
		...
		Text.Add("The moth gives a little gasp as the first shot of seed spills into her but keeps on moving. The second spurt of cum you send splattering across her pussy's writhing walls sends her over the edge too, breaking the kiss as she throws her head back with an exultant cry. You pull her down on your [cock], ramming yourself in [c], shooting the rest of your load deep into her. She's more than happy to take it if the way she moans and gasps is any indication!", parse);
		Text.NL();
		
		var cum = player.OrgasmCum();
		
		Text.Add("You collapse against the treetrunk, chest heaving with exertion as the moth slumps forward, head resting against your [breasts]. Her wings flitter weakly behind her, arms wrapping around your neck to hold you tight. Pinned underneath a heap of warm, fuzzy moth-girl, you don't have many options but to lock your arms around her waist and return the favor, closing your eyes in momentary contentment.", parse);
		Text.NL();
		Text.Add("It's only an hour later that you wake up from you unexpected nap, rubbing the sleep out of your eyes as you stagger to your [feet], just in time to see the moth-girl standing at the edge of the clearing, getting ready to take flight. Hearing you move, she flashes a cute grin over her shoulder, wings lifting her a few inches off the ground.", parse);
		Text.NL();
