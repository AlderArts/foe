...
Scenes.Mothgirl.Loss = function(enc, traded) {
	...
	scenes.AddEnc(function() {
		...
		Text.Add("Waves of pleasure wash over you, or through you, as the moth-girl starts to suck you off. Despite her victorious stance, she seems more than willing to let you guide her through it, your hand controlling the pace and tempo of her blowjob. Her tongue writhes around and constricts your [cock], alternating pressure and wet, sliding movements while her lips bob from crown to base, sucking you off around her overly-long appendage. The sensation is alien - and totally overwhelming. Your fingers dig into the moth's silky white hair, trying desperately to find purchase. Your [legs] squirm[LnotS] madly, wracked with over-stimulation, trying desperately to keep you from cumming. ", parse);
		Text.NL();
