...
Scenes.Naga.DesertLossGetDPd = function(enc) {
	...
	Text.NL();
	Text.Add("In what seems like hours, but is actually less than a minute, the serpentess crosses the edge. She pushes her massive rods into your holes as far as possible and grinds her hips roughly against your ass as if to push her cocks further in than her body would allow. You feel the embedded erections pulse, becoming significantly thicker periodically as the naga breaks into another shout of utmost pleasure.", parse);
	Text.NL();
...
Scenes.Naga.DesertWinFuckJerk = function(enc, hypno) {
	...
	if(p1cock.Len() <= 13)
		...
		Text.Add("Your [cockTip] bumps against the back of your scaly slut’s throat. Her lips curl slightly; an attempt to smile at you around the thickness of your tool. Her eyes flutter closed as she swallows, drawing the next inch of your [cockDesc] into the succulent tightness of her throat. She opens her eyes as she pushes her head further down, engulfing the rest of your throbbing maleness and forming a tight seal around your base with her lips.", parse);
		Text.NL();
