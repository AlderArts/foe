...
function GolQueen() {
	...
	//3'
	this.FirstVag().capacity.base = 91;
...
Scenes.Gol.CombatWinTailfuck = function(enc, p1cock) {
	...
	Text.NL();
	Text.Add("The Gol shudders, and her shoulderblades shift in the most delightful way, highlighting the perfect arch her back is making. She's not looking back anymore; her body is too wracked with ecstasy for her to watch you enjoy her backdoor any longer. Flecks of her girl-honey splatter over the ground below with each powerful hump. She may be still be inhumanly tight, but the tightness is now driving you to pound it all the harder. You're determined to fuck the exotic pussy into your sloppy, slippery mate, determined to ravish it wholly and utterly.", parse);
	Text.NL();
