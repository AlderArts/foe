...
Scenes.Equine.GetFucked = function(enc) {
	...
	Text.NL();
	Text.Add("Taking control, you press the equine onto his back. He thumps against the ground with a gruff groan and you swiftly mount his chest, your legs folded between his body, lying against the cold stone. Your [vagDesc] squelches against his muscled chest leaving a trail of natural lube. Sensually, you push yourself back, until your [buttDesc] is pressing against his meaty rod.", parse);
	Text.NL();
...
Scenes.Equine.WinFuckHer = function(enc) {
	...
	Text.Add("Under normal circumstances, you might have just let them be and continued on your way. But as you loom over your defeated adversaries, the sight of their fit, exposed bodies incites a wave of arousal within you. Your [multiCockDesc] grow[notS] stiff with need, lust warring with what remains of your self-restraint. It is a losing battle, especially after the scent of the equines’ arousal hits you full in the face. Your hands move on their own; a quick tug exposes your pulsating package to the warm air[b]. Both horses swallow reflexively as you favor them with an excited grin. This ought to be an interesting ride.", parse);
	Text.NL();
...
Scenes.Equine.WinRideHimVag = function(enc) {
	...
	Text.Add(" Instead, you decide to shift forward, dragging your [nipsDesc] along the horse's chest and allowing most of his length to slip out until only the flared head remains inside you. As your [breastDesc] dangle above the stallion's muzzle, a sudden urge strikes you. You grab the unsuspecting equine's chin with one hand and shove one of your nipples into his mouth.", parse);
	Text.NL();
	...
	Text.Add("After a few more squirts, the stallion is spent. He is sprawled limply on the ground beneath you, his tongue lolling out and his eyes almost crossed from the intense pleasure. You can feel his cock shrinking inside you and it soon flops out to allow a cascade of spunk to pour from your [vagDesc], coating his lower body white. You click your tongue in disappointment; you were quite close to your own release - and being deprived like that has left you a little edgy. There must be some way to...", parse);
	Text.NL();
