...
import { Stat } from "../../../engine/entity/stat";
...
import { ILocBullTower } from "../../../engine/navigation/location";
...
export class BullTowerStats {
    ...
    public stoleLantern: boolean;
    public guardsDown: boolean;
    public towerGuardDown: boolean;
    ...
    () => {
        ...
        options.push({ nameStr : "Sneak",
            func() {
                ...
                const dex = player.Dex() + Math.random() * 20;
                if (dex >= 70) {
        ...
        options.push({ nameStr : "Distract",
            func() {
                ...
                const intel = player.Int() + Math.random() * 20;
...
export namespace BullTowerScenes {
    ...
    export function CorishevImpregnate(mother: Entity, father: Corishev, slot?: number) {
        ...
        if (BT.unlockedSafe && !(outlaws.flags.BT & OutlawsFlags.BullTower.SafeLooted)) {
            options.push({ nameStr : "Disarm",
                func() {
                    ...
                    let check = (player.Int() + player.Dex()) / 2 + Math.random() * 20;
            ...
            options.push({ nameStr : "Fake Out",
                func() {
                    ...
                    let check = player.Dex() + Math.random() * 20;
                    check += player.jobs.Rogue.level * 5;
    ...
    export function EndingSlipOut() {
        ...
        BullTowerScenes.EndingDebrief(false);
    }
