...
import { ILocRigardBrothel } from "../../../engine/navigation/location";
...
// Brothel
//
BrothelLoc.Brothel.description = () => {
...
export namespace BrothelScenes {
	export function IsOpen() {
		return !GAME().rigard.UnderLockdown(); // No closed hours
	}

	export function NewMStrap() {
		const cock = new Cock(Race.Human);
	...
	export function MStrap() {
		...
		const num = rigard.Brothel.MStrap;
