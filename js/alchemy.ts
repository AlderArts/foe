...
export namespace Alchemy {
	...
	export function AlchemyPrompt(alchemist? : Entity, inventory? : Inventory, backPrompt? : any, callback? : any, preventClear? : boolean) {
	...
	export function MakeItem(it : Item, qty : number, alchemist : Entity, inventory : Inventory, backPrompt : any, callback : any, remove : boolean) {
		Text.Clear();
	...
	export function ItemDetails(brewable : any, inventory : Inventory) {
	...
	export function GetRecipeDict(it : Item) {
	...
	export function CountBrewable(it : Item, inventory : Inventory, alchemist : Entity) {
	...
	export function AdaptRecipe(recipeDict : any, invDict : any, alchemist : Entity) : any {
