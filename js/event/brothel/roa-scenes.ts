...
export namespace RoaScenes {
    ...
    export function TalkPrompt(backPrompt: any) {
        ...
        */
        ...
        if (burrows.flags.Access >= BurrowsFlags.AccessFlags.Stage3 && roa.flags.Lagon < RoaFlags.Lagon.Talked) {
        ...
        options.push({ nameStr : "Buy",
            func() {
                ...
                if (player.NumCocks() > 1) {
                    ...
                    Text.Flush();
                    // [Peg]
                    const tooltip = player.Strapon() ? "He’s just begging to get pegged, and you have the proper equipment to give him what he wants. So why not give this bunny-boy a good butt-fucking?" : "Come on, he’s begging for it; have him call in a toy for you so you can ream his ass.";
    ...
    export function TSLCatchVaginal() {
        ...
        const first  = (roa.sex.gVag  === 0);
        const noanal = (roa.sex.rAnal === 0);
        ...
        Gui.Callstack.push(() => {
            ...
            Gui.Callstack.push(() => {
                ...
                Gui.Callstack.push(() => {
                    ...
                    RoaScenes.TSLPostSexPrompt(false);
                });
            });
        });
    }
