...
LagonScenes.RulerBlowjobSwallowEntrypoint = function(opheliaPresent : boolean) {
	var parse : any = {
...
LagonScenes.RulerBlowjobAftermath = function(opheliaPresent : boolean) {
	let player = GAME().player;
	let lagon = GAME().lagon;
...
//TODO
LagonScenes.RulerGetFuckedEntrypoint = function(opheliaPresent : boolean) {
	let player = GAME().player;
	let lagon = GAME().lagon;
...
//TODO
LagonScenes.RulerGetFuckedEntrypoint2 = function(angry : boolean, target : BodyPartType, opheliaPresent : boolean) {
	let player = GAME().player;
...
LagonScenes.Usurp = function(toolate : boolean) {
	var parse : any = {
