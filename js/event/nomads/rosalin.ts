...
RosalinScenes.Impregnate = (mother: Entity, father: Entity, slot?: number) => {
...
RosalinScenes.FirstFuckPegWolf = () => {
	const player = GAME().player;
	const rosalin = GAME().rosalin;
	const cale = GAME().cale;
	Text.Clear();
...
RosalinScenes.FirstFuckFollowup = (outcome: number) => {
...
RosalinScenes.CombineCallback = (item: TFItem) => {
	const player = GAME().player;
	const party: Party = GAME().party;
	const rosalin = GAME().rosalin;
	const cale = GAME().cale;
...
RosalinScenes.SexPrompt = (state: RosalinSexState) => {
	const player = GAME().player;
	const rosalin = GAME().rosalin;
	const cale = GAME().cale;
...
RosalinScenes.CockWorship = (sexState: RosalinSexState) => {
	const player = GAME().player;
	const rosalin = GAME().rosalin;
	Text.Clear();
