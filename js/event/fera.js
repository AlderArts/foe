	...
	options.push({ nameStr : "Fondle",
		func : function() {
			...
			if(fera.relation.Get() >= 8) {
				Text.Add("Taking Fera's hand, you lead her behind a large rack of clothes and have her turn around. Pulling down her dress, you pop out her [fbreasts]. You cup one of her [fbreasts] in each hand and proceed to massage them from behind. Fera purrs and moans as you squeeze her [fbreasts]. Shifting your hands up a bit, you rub her [fnips] with your fingers.", parse);
				Text.NL();
				var noble = false;
				...
				if(player.FirstCock()) {
					Text.Add("As you continue to play with her [fnips], you feel a hand on your [botarmor], feeling for your [cocks]. She finds what she is looking for, her hand rubbing up and down your [cocks] as you continue to play with her [fbreasts]. As you fondle her [fbreasts] harder, she accelerates her pace on your [cocks]. The two of you moan almost in unison as you please each other.", parse);
					Text.NL();
				}
				if(player.HasBalls())
					...
					Text.Add("You feel Fera's hand reaching around your [botarmor] until she finds the folds of your [vag]. You squeeze her [fbreasts] tighter as you feel her fingers rub up and down your [vag]. She responds by trying to force her finger inside you through your [botarmor]. The sudden sensation causes you to pinch her [fnips], which only makes her push harder. You both moan softly as you do your best to please each other.", parse);
				Text.NL();
...
Scenes.Fera.SexPrompt = function() {
		...
		func : function() {
			...
			if(fera.relation.Get() < 10) {
				...
				if(breasts) {
					...
					Text.NL();
					Text.Add("Her hands fondle your [breasts] roughly, trying to pull the [garment] down. After a few moments, the [garment] slides down and she gives your [breasts] a final cup to make sure the [garment] fits.", parse);
					Text.NL();
				}
				...
				if(p1Cock) {
					...
					Text.NL();
					Text.Add("The [garment] slides down to your [cocks], forcing her to reach down to help get it past the obstruction[s]. She holds your [cocks] down while stroking them gently and pulls the [garment] down with her other hand. While she does this, her stiff [fnips] dig into your back a little as she holds you tight. She then rubs her hands over your [cocks] a few times, massaging [itThem] firmly while making sure that the [garment] fits.", parse);
					Text.NL();
				...
				if(player.FirstCock()) {
					...
					Text.NL();
					Text.Add("As you play with each other, she leans in to kiss you. At the same time, you feel one of her hands move to your [vag] and begin to rub her fingers along it. You moan quietly as you feel her push inside your [vag]. She then begins to rub your inner walls with one of her fingers, rubbing against your [clit] with her tiny palm.", parse);
					Text.NL();
					Text.Add("Unable to do much else, you squeeze her [fbreasts] harder and rub her [fnips] with your fingers as she pleasures you. She presses against you harder, and you can feel her [fbreasts] against your stomach.", parse);
					Text.NL();
					...
					Text.Add("A few minutes later you can take no more, and your body tenses as you orgasm. Fera pulls her wet fingers out of your [vag] and helps you remain standing as your [legs] weaken slightly. Your breathing slows as you cuddle with her for a moment.", parse);
					Text.NL();
	...
	if(fera.relation.Get() >= 10) {
		options.push({ nameStr : "Give oral",
			func : function() {
				Text.Clear();
				Text.Add("You instruct Fera to sit on the small bench, spread her legs and lift up her dress. She does as you command, the dress' pink ruffles bunched around her waist, and you kneel on the floor in front of her. Pushing aside her white silk panties, you reveal her [fvag]. Pulling in close, you begin to lick it gently, tasting her sweet folds with your [tongue].", parse);
				Text.NL();
				...
				Text.NL();
				Text.Add("Understanding her desire, you continue your pleasurable assault. She begins to purr with each lick of your [tongue], encouraging you to lick faster. After a few minutes, she pushes you down hard, shoving your face into her nethers. You feel her body tense, a shudder running through her. Reaching her climax, the catgirl mewls softly as she rides out her orgasm.", parse);
				Text.NL();
			...
			func : function() {
				...
				if(player.FirstCock()) {
					...
					if(player.NumCocks() == 2) {
						Text.Add("You feel her hand on your other [cockDesc2], jerking it roughly as she continues to lick your [cock] lovingly. She proceeds to switch cocks and puts the second of your [cocks] into her mouth while she strokes the first. The cute catgirl goes back and forth between your [cocks], paying each equal attention.", parse);
						Text.NL();
					}
					...
					if(player.CumOutput() > 3) {
						...
						Text.Add("You soon reach your limit under her passionate service, cumming hard. She swallows your load greedily, gently licking your [cocks][ballsD] clean. <i>“Your cum tastes so good, [playername]...”</i> she murmurs, licking her lips. Gently patting her head, you promise to give her more later. She purrs happily, handing you your [botarmor]. Putting it back on, you leave the dressing room together.", parse);
					}
					
					fera.flags["Blowjob"]++;
				}
				else { // Vag
					Text.Add("You sit down on the small bench and remove your [botarmor], spreading your legs to reveal your [vag]. Fera gets on her knees and begins to lick it tenderly with her rough, catlike tongue. It feels incredible, and you cannot help but moan at the intense pleasure running up your spine.", parse);
					Text.NL();
	...
	if(fera.relation.Get() > 15) {
		options.push({ nameStr : "Titfuck",
			func : function() {
				...
				Text.NL();
				Text.Add("She nods and pulls her dress down revealing her [fbreasts] and erect [fnips], kneeling in front of you. The catgirl rubs[oneof] your [cocks] with her hands, and puts it between her soft [fbreasts]. She gives your [cock] a gentle squeeze with her [fbreasts] and leans down to lick up all of your salty pre. Fera starts moving up and down slowly, massaging your [cock] with her [fbreasts]. Each time it nears her face, she gives your [cock] a little kiss before continuing to rub it with her [fbreasts].", parse);
				Text.NL();
				Text.Add("You moan softly as she pleasures you, which only encourages the cute catgirl more. After a few minutes, she stops moving, and squeezes down hard on your [cocks] with her [fbreasts]. Sticking out her tongue, she takes the [cockTip] of[oneof] your [cocks] into her mouth and licks around it with her rough tongue. She passionately licks around the [cockTip] of your [cock], some of her saliva escaping her mouth and starting to drip down your [cock]. You shudder at her ministrations, which only makes her squeeze all the harder.", parse);
				Text.NL();
	...
	if(fera.relation.Get() >= 20 && fera.FirstVag().virgin) {
		options.push({ nameStr : "Sex",
			func : function() {
				...
				Text.NL();
				Text.Add("She reaches down and grabs[oneof] your [cocks], stroking it slowly. After a minute, you interrupt her, and pull back, telling her to lick your [cock] instead. She gently licks the entire length of your [cock], coating it in her saliva. You ready yourself to fuck her as she stares at you nervously.", parse);
				Text.NL();
				...
				if(player.NumCocks() === 0) {
					...
					if(player.CumOutput() > 3) {
						...
						Text.Add(". However, there is not enough room in her [fvag] for your load and it starts to gush out and drip down your [cocks]. Pulling out your [cock], you see the cute catgirl is panting heavily, looking up happily at you.", parse);
						Text.NL();
	...
	if(fera.relation.Get() >= 20 && !fera.FirstVag().virgin) {
		options.push({ nameStr : "Standing",
			func : function() {
				...
				Text.Add("Unable to hold back any longer, you piston into her, as she grabs one of her [fbreasts] and begins to squeeze it, eager for more pleasure. Her insides are warm and tight, and feel amazing around your [cock].", parse);
				Text.NL();
				...
				if(fera.flags["Standing"] >= 3) {
					...
					Text.Add("Fera lets out quiet moans as you push into her [fvag]. She stares into your [eyes], with a pleased look on her face. After a while, you decide to thrust faster, making the catgirl moan even louder. She quickly grabs her other [fbreasts] and begins to play with her [fnips]. Fera is clearly enjoying this, despite having little experience. She pinches her stiff [fnips] and begins to twist them gently as she plays with her [fbreasts].", parse);
				}
				Text.NL();
				...
				if(player.NumCocks() === 0) {
					...
					Text.NL();
					Text.Add("You pull out of her, and she kneels down, licking the remaining juices from your [cocks], gulping them down greedily. <i>“Thanks so much, [playername]...”</i> she says after licking her lips.", parse);
		...
		options.push({ nameStr : "Behind",
			func : function() {
				Text.Clear();
				Text.Add("As you quietly remove your [botarmor], your [cocks] flop out. Fera stares intently at your equipment as you tell her to pull her dress up and pull down her panties. With her mound now exposed, you press against her, putting your [cocks] between her legs. You begin to push back and forth, rubbing your [cocks] against the wet lips of her [fvag].", parse);
				Text.NL();
				parse["ballsD"] = player.HasBalls() ? Text.Parse(" and begin to drip down your [balls]", parse) : "";
				Text.Add("She purrs and pulls down her dress, presenting her [fbreasts] to you. Knowing what she wants, you grab her [fbreasts] and firmly squeeze them. The cute catgirl begins to squeeze her thighs together, increasing the stimulation on your [cocks]. Her juices coat your [cocks] as you thrust between her legs[ballsD].", parse);
				Text.NL();
				if(p1Cock.length.Get() >= 18)
					Text.Add("<i>“Your cock[s] [isAre] so big, [playername]...I can't wait anymore...”</i> Fera moans needily. ", parse);
				Text.Add("You kiss Fera deeply and pull your [cocks] out from between her legs. Turning her around, you tell her to lean against the wall and spread her legs.", parse);
				Text.NL();
				if(fera.flags["Behind"] >= 3) {
					Text.Add("Fera spreads her legs eagerly for you, leaning against the wall of the dressing room. She shakes her hips, inviting your [cocks] inside. From this angle, you can easily see her juices dripping from her [fvag] and down her legs. You walk over to her and playfully ask what she wants, your hand patting her exposed [fbutt].", parse);
					Text.NL();
					...
					Text.Add("You reward her begging by thrusting hard, smacking her ass with each thrust. She purrs and moans as she begins to thrust back at you passionately. Fera takes one hand off the wall and begins to fondle one of her [fbreasts], as you increase the speed of your thrusts. Her juices are now flowing out and down your [cock][ballsD].", parse);
				}
				else {
					...
					Text.Add("Leaning over as you thrust into her, you reach around and grab her [fbreasts]. Fera moans quietly as you squeeze her [fbreasts], and ram your [cock] deep inside her. The catgirl pants and moans as you fuck her, and you think you feel her thrusting back a little. Your hands move up her [fbreasts], and you playfully twist her [fnips]. Thrusting harder, you can feel the warmth radiating from her [fvag], and a steady drip of her fluids hitting the floor.", parse);
				}
				Text.NL();
			...
			options.push({ nameStr : "Anal",
				func : function() {
					...
					if(fera.Butt().virgin) {
						...
						Text.NL();
						Text.Add("You stick in one of your fingers slowly, probing her [fanus]. As you stick in your second finger, she tightens up and squeezes. You move your fingers in and out a few times, spreading her [fanus] wide with them. She lets out a quiet moan as you pull them out, readying your [cock].", parse);
						Text.NL();
						Text.Add("You press the tip against her [fanus], and push in firmly. She gasps quietly, and you can hear her breathing heavily. Her [fanus] is warm and very tight, almost too much so, as you struggle to move inside her. You tell her to relax, but it does little good. You do the best you can and make short thrusts, the tightness and warmth giving you most of the pleasure.", parse);
						Text.NL();
						...
						Text.Add("Her [fanus] is still tight and warm, but loose enough for you to move easily. Taking advantage of her obvious desire, you pound her hard and fast, and are rewarded by her desperate moans growing louder.", parse);
						Text.NL();
						Text.Add("<i>“Yes...”</i> she whispers, panting, <i>“more...”</i> As enjoyable as this is, you decide to make things more interesting. Grabbing hold of her tail, you give it a firm tug, causing her [fanus] to clamp down hard on your [cock], as a startled mew escapes from her mouth. Despite any pain from you tugging on her tail, the catgirl seems to enjoy it immensely, and pants heavily.", parse);
						Text.NL();
		...
		if(fera.relation.Get() > 30) {
			options.push({ nameStr : "Sitting",
				func : function() {
					...
					Text.NL();
					Text.Add("Fera jumps into your lap, kissing you roughly while rubbing your [cocks] with her [fvag]. You can feel her warm, wet lips through her soaked panties as she rubs back and forth against you. The catgirl's juices have completely stained her white silk panties and are running down both of her legs. Her soft [fbreasts] press against your [breasts], and you feel her stiff [fnips] push against you.", parse);
					Text.NL();
					Text.Add("As she squeezes you tighter, you feel her juices thoroughly coating your [cocks] even through her panties", parse);
					if(player.HasBalls())
					...
					Text.Add("The initial sensation is intense, and her snatch feels warmer and wetter than usual. She looks into your [eyes], kissing you deeply as she begins to bounce in your lap.", parse);
					Text.NL();
					if(p1Cock.length.Get() >= 18) {
