...
Scenes.Fera.Interact = function() {
	...
	Text.Clear();
	Text.Add("Fera is a cute little catgirl. She has large blue eyes and short chestnut hair, brown fur with white spots, and large catlike ears and a tail. She is wearing a very nice looking pink dress with short sleeves and little ruffles along the edges. It is cut above her knees and shows off her slender form very nicely. Her chest is large for her overall size, but it is nothing compared to Miss Nexelle's. Her dress is cut around her [fbreastDesc] so that her cleavage is clearly visible.", parse);
	Text.NL();
	...
	if(fera.flags["Met"] == 0) {
		...
		if(fera.relation.Get() > 25)
			...
			Text.Add("As soon as she can see you, Fera smiles and runs over. She jumps into your arms and purrs softly as she rubs her head against your [breastDesc].", parse);
	...
	options.push({ nameStr : "Fera",
		func : function() {
			...
			if(fera.relation.Get() > 10)	
				...
				Text.Add("<i>“Me? Um... I like milk, cream, and soft things. I've worked here for as long as I can remember. I carried things when I was small, and I sewed when I got bigger. I sometimes do errands for Miss Nexelle, thats the only time I really get to go out...”</i> she says sadly.", parse);
			Text.Flush();
			Gui.NextPrompt(Scenes.Fera.Interact);
		}, enabled : true,
		...
		options.push({ nameStr : "Mother",
			func : function() {
				...
				options.push({ nameStr : "Apologize",
					func : function() {
						Text.Add("You apologize to Fera for making her cry. <i>“Its ok...”</i> she sniffs. <i>“I should get back before I get in trouble again...”</i>", parse);
						Text.Flush();
						fera.relation.IncreaseStat(100,1);
						fera.flags["Mom"] = 2;
						Gui.NextPrompt(Scenes.Fera.Interact);
	...
	options.push({ nameStr : "City",
		func : function() {
			...
			options.push({ nameStr : "Disagree",
				func : function() {
					Text.Add("Shaking your head, you tell her that you don't think its likely or possible for different creatures to be treated as well as humans. You explain that creatures who are different should be treated different. Unsurprisingly, she looks very angry at your words and hurries off, saying nothing.", parse);
					Text.Flush();
	...
	options.push({ nameStr : "Cuddle",
		func : function() {
			...
			if(fera.relation.Get() >= 5) {
				Text.Add("Fera comes close and purrs as you pull her into your arms. She puts her arms around you and rubs her head [against] your [breastDesc] in return. Clearly she appreciates someone being kind to her.", parse);
				Gui.NextPrompt(Scenes.Fera.Interact);
...
Scenes.Fera.SexPrompt = function() {
	...
	Text.NL();
	Text.Add("Upon arriving in the dressing room, you admire the cute catgirl. You stroke her head gently as you look over her various attributes. Thinking as you stroke her, you consider what to do.", parse);
	Text.Flush();
	...
	options.push({ nameStr : "Try on",
		func : function() {
			...
			if(fera.relation.Get() < 10) {
				Text.Add("She looks away as you remove your [lowerArmorDesc]. When you are finished she hands you the [garment] and moves behind you to help you get it on.", parse);
				Text.NL();
				...
				if(player.FirstCock()) {
					Text.Add("As the [garment] goes down over your [multiCockDesc], it gets stuck on[oneof] your member[s]. You tell Fera to help you and she lets out a small whine. She reaches around you with one hand and tries to pull the [garment] down without touching your [multiCockDesc]. It's a futile effort, however.", parse);
					Text.NL();
					Text.Add("She uses one hand to hold down your [multiCockDesc], while pulling the [garment] over [itThem] with the other. As she pulls the snugly fitting fabric over your member[s], you can feel her [fbreastDesc] pressing into your back. They are soft but firm, and you press back slightly as she pulls the [garment] over your [multiCockDesc].", parse);
					Text.NL();
				}
				...
				Text.NL();
				if(player.FirstCock()) {
					Text.Add("You notice her eyes are focusing on your [multiCockDesc] as she looks at you. Clearly she knows what to look for, even if she won't directly compliment you on [itThem].", parse);
					Text.NL();
				}
				if(breasts) {
				...
				Text.Add("Fera nods excitedly and helps you remove your [lowerArmorDesc][toparmor].", parse);
				Text.NL();
				
				if(p1Cock) {
					parse["br"] = breasts ? Text.Parse(" and [breastDesc]", parse) : ""
					Text.Add("She takes the time to feel your [multiCockDesc][br] as much as she can while you strip. You can also feel her [fbreastDesc] rubbing against you constantly, along with her stiff [fnipsDesc]. She helps you put the [garment] over your head and then begins to pull it down. Running her hands over your [breastDesc], she feels for a good fit.", parse);
					Text.NL();
					...
					Text.NL();
					Text.Add("After telling her you like it, you ask for help taking the [garment] off, and she takes her position behind you. She begins to lift the [garment] , but does so slowly and takes time to feel every curve of your body. As she lifts the [garment] over your head she presses against you once again, and you feel her [fbreastDesc].", parse);
					Text.NL();
				...
				if(player.FirstCock()) {
					...
					Text.Add("You stand up and walk toward the catgirl only to have her eagerly push you up against the wall of the dressing room. She gives your face a long lick as she fondles your [breastDesc] lovingly. Feeling a need to return the favor, you grab her [fbreastDesc] and massage them firmly.", parse);
					Text.NL();
	...
	if(fera.relation.Get() >= 10) {
		options.push({ nameStr : "Give oral",
			func : function() {
				...
				Text.NL();
				Text.Add("Understanding her desire, you continue your pleasurable assault. She begins to purr with each lick of your [tongueDesc], encouraging you to lick faster. After a few minutes she pushes you down hard, shoving your face into her nethers. You feel her body tense, a shudder running through her. Reaching her climax, the catgirl mewls softly as she rides out her orgasm.", parse);
				Text.NL();
		...
		options.push({ nameStr : "Get oral",
			func : function() {
				...
				if(player.FirstCock()) {
					...
					Text.Add("Whispering quietly, you tell Fera to please your [multiCockDesc] with her mouth. She smiles and nods as she waits for you to undress. You sit on the small bench and take off your [lowerArmorDesc], revealing your [multiCockDesc][balls].", parse);
					Text.NL();
					
					if(player.FirstCock().length.Get() > 25) {
						Text.Add("Upon seeing your [multiCockDesc], the cute catgirl's eyes widen in shock. <i>“[itsTheyre] <b>huge</b>, [playername]! But I'll try my best...”</i> Fera says with a nervous smile. You give her a gentle push, telling her to assume a kneeling position in front of you. Clearly, she's intimidated by your sheer size.", parse);
						Text.NL();
					}
					...
					scenes.AddEnc(function() {
						...
						Text.Add("Fera shifts her hands onto[twoof] your other cocks, and begins to jerk them roughly. Her mouth pops off your [cockDesc], and she takes a different one into her mouth. Clearly she wants to please as much of you as she can, and she takes turns sucking and jerking each of your [multiCockDesc]. You cannot help but admire her passionate efforts.", parse);
						Text.NL();
					...
					if(player.CumOutput() > 3) {
						...
						if(player.NumCocks() > 1) {
							parse["s"]    = player.NumCocks() > 1 ? "s" : "";
							parse["notS"] = player.NumCocks() > 1 ? "" : "s";
							Text.Add(" Your other member[s] also erupt[notS], hosing the walls of the dressing room and making a big mess.", parse);
						}
					...
					Text.Add("You sit down on the small bench and remove your [lowerArmorDesc], spreading your legs to reveal your [vagDesc]. Fera gets on her knees and begins to lick it tenderly with her rough, catlike tongue. It feels incredible, and you cannot help but moan at the intense pleasure running up your spine.", parse);
					Text.NL();
					Text.Add("The cute catgirl seems to be enjoying herself as well, and you can see her blue eyes looking up at you as she licks your [vagDesc] enthusiastically. Her fingers shift to play with your [clitDesc], pinching it while she continues licking. Fera's tongue reaches deeper inside your [vagDesc], its roughness pleasant against your walls.", parse);
					Text.NL();
	...
	if(fera.relation.Get() > 15) {
		options.push({ nameStr : "Titfuck",
			func : function() {
				...
				Text.NL();
				Text.Add("Finally you near your limit and your [multiCockDesc] begin[notS] to twitch, prompting her to lick faster, pressing her tongue more firmly against your [cockDesc]. The catgirl moves up and down, clamping down on you as hard as possible.", parse);
				Text.NL();
				...
				if(player.CumOutput() > 3) {
					...
					Text.Add(". However, your seed soon starts to leak out from her mouth and run down your [multiCockDesc] and all over her [fbreastDesc], although, cupping her hands, she barely manages to keep most of it off her dress.", parse);
					Text.NL();
					Text.Add("She happily licks up as much as she can off your [multiCockDesc] and herself, and grabs a rag from under the bench to clean up the rest. You put your [lowerArmorDesc] back on, and help her clean. After fixing her dress as best you can, you give Fera a quick hug and lead her out into the store.", parse);
				}
				else  {
					Text.Add("Your [multiCockDesc] spurt[notS] forcefully as you cum, filling her mouth with your seed", parse);
					if(player.NumCocks() > 1) {
						Text.Add(", while your other cock[s] shoot[notS] your seed onto the walls", parse);
					}
					Text.Add(". With small gulps she slowly swallows it all, taking time to savor her favorite salty treat. After she's done, she licks the rest of your [multiCockDesc][balls] clean, and grabs one of the rags under the small bench to wipe off the walls. You get your [lowerArmorDesc] back on, and give her a kiss. Together, you exit the dressing room.", parse);
				}
				Text.Flush();
				world.TimeStep({minute: 30});
				player.AddLustFraction(-1);
	...
	if(fera.relation.Get() >= 20 && fera.FirstVag().virgin) {
		options.push({ nameStr : "Sex",
			func : function() {
				...
				Text.NL();
				Text.Add("<i>“Um... I've never...”</i> she stammers. Pulling her face up to meet yours, you ask again if she wants to. She looks deeply into your [eyeDesc]s. <i>“You are the only person I have ever wanted to do this with, [playername]. I'll try my best...”</i>", parse);
				Text.NL();
				Text.Add("With a smile you tell Fera to sit on the bench, lift up her dress and remove her panties. She does as you ask while you take off your [lowerArmorDesc]. Her eyes stare intently at your [multiCockDesc] as you pull down her dress to reveal her [fbreastDesc].", parse);
				Text.NL();
				...
				Text.Add("You kiss her deeply and your [tongueDesc] intertwines with hers as you fondle her [fbreastDesc] roughly.", parse);
				Text.NL();
				Text.Add("She reaches down and grabs[oneof] your [multiCockDesc], stroking it slowly. After a minute, you interrupt her, and pull back, telling her to lick your [cockDesc] instead. She gently licks the entire length of your [cockDesc], coating it in her saliva. You ready yourself to fuck her as she stares at you nervously.", parse);
				Text.NL();
				...
				Text.NL();
				Text.Add("A quiet moan escapes her, and she squeezes you tighter. The moan is followed by more, and they grow louder, as she clamps down on you with her legs. You figure it is finally starting to feel good for her and pound harder into her warm depths.", parse);
				Text.NL();
				...
				if(player.NumCocks() === 0) {
					Text.Add("You can tell she's getting close and as you bury yourself as deep as you can she clamps down on your [cockDesc] and struggles to keep her voice down.", parse);
					Text.NL();
					Text.Add("You pull out your [cockDesc], and look to see Fera breathing heavily and looking tired, but pleased.", parse);
					Text.NL();
					...
					if(player.CumOutput() > 3) {
						Text.Add("You feel yourself going over the edge, and give one last hard thrust, burying yourself as deep as you can. You cum hard, and your huge load fills up her [fvagDesc]", parse);
						if(player.NumCocks() > 1)
							Text.Add(", as your other cock[s] spurt[notS] cum all over the floor and walls, making a big mess", parse);
						Text.Add(". However there is not enough room in her [fvagDesc] for your load and it starts to gush out and drip down your [multiCockDesc]. Pulling out your [cockDesc], you see the cute catgirl is panting heavily, looking up happily at you.", parse);
						Text.NL();
						Text.Add("You help Fera clean up and fix her clothes, and she helps you with your [lowerArmorDesc]. She comes close and embraces you. <i>“We can do it again sometime... if you want...”</i> she says while rubbing her head against your [breastDesc]. You open the dressing room door and let Fera return to work.", parse);
					}
					else {
						Text.Add("As you reach your limit, you push yourself in to the hilt. You shoot your load deep inside her [fvagDesc]", parse);
						if(player.NumCocks() > 1)
							Text.Add(" as your other cock[s] spurt[notS] your cum all over the floor", parse);
						Text.Add(". As you pull out your [cockDesc], you look to see Fera breathing heavily and looking tired, but pleased.", parse);
						Text.NL();
						Text.Add("You help each other get dressed and you kiss her again before you leave. <i>“If you want to do it again... let me know,”</i> she says quietly. The two of you exit the dressing room together and return to the main area of the store.", parse);
					}
				}
	...
	if(fera.relation.Get() >= 20 && !fera.FirstVag().virgin) {
		options.push({ nameStr : "Standing",
			func : function() {
				Text.Clear();
				Text.Add("As you begin to remove your [lowerArmorDesc], you tell Fera to pull up her dress and remove her panties. She does as you ask and stares intently at you, occasionally glancing down at your [multiCockDesc][balls].", parse);
				Text.NL();
				Text.Add("You motion to her to get down and lick your [multiCockDesc]. She eagerly kneels down and turns her attention to your [cockDesc], running her tongue along its length", parse);
				if(player.NumCocks() > 1) {
					parse["s"] = player.NumCocks() > 2 ? "s" : "";
				...
				Text.NL();
				if(p1Cock.length.Get() >= 18) {
					Text.Add("<i>“[itsTheyre] so big, [playername].”</i> she purrs as she licks your [multiCockDesc].", parse);
					Text.NL();
				}
				Text.Add("Once your [cockDesc] is coated in her saliva, you tell her that's enough for now. She stands up, waiting for your instructions, and you gently push her against the side wall of the dressing room. You kiss her roughly as you pull down her dress to reveal her [fbreastDesc] and begin to play with them. She purrs softly and pulls you closer.", parse);
				Text.NL();
				Text.Add("After playing with her [fbreastDesc] for a few minutes, you stand back slightly, and raise one of her legs. The cute catgirl breathes heavily as the tip of your [cockDesc] touches her moist [fvagDesc]. As you push inside her, she lets out a desperate moan and leans over to kiss you again.", parse);
				Text.NL();
				
				player.Fuck(p1Cock, 3);
				
				Text.Add("Unable to hold back any longer, you piston into her, as she grabs one of her [fbreastDesc] and begins to squeeze it, eager for more pleasure. Her insides are warm and tight, and feel amazing around your [cockDesc].", parse);
				Text.NL();
				
				if(fera.flags["Standing"] >= 3) {
					Text.Add("The cute catgirl moans lustfully with each thrust of your [cockDesc], and has clearly grown to love this. You grab her other [fbreastDesc] and fondle it roughly as you continue to kiss the catgirl. She puts her free arm around you and holds you tight.", parse);
					Text.NL();
					Text.Add("As you press against her, your [cockDesc] goes deeper and the catgirl purrs at the sensation. You thrust even harder, urged on by her tightly squeezing [fvagDesc]. Her nails dig into the back of your neck a little with each forceful thrust.", parse);
				}
				else {
				...
				if(player.NumCocks() === 0) {
					Text.Add("Seeing her this turned on is a particularly satisfying treat. Her smile vanishes in surprise when you push your [cockDesc] as deep into her [fvagDesc] as it can go. She gasps in pleasure and cums soundlessly.",parse);
					Text.NL();
					Text.Add("You pull out of her, and she kneels down, licking the remaining juices from your [multiCockDesc], gulping them down greedily. <i>“Thanks so much, [playername]...”</i> she says after licking her lips.", parse);
					Text.Add(" You put your [lowerArmorDesc] back on, and help her fix her dress. You open the door and you both head back out to the store.", parse);
				}
				else {
					if(player.CumOutput() > 3) {
						parse["mc"] = player.NumCocks() > 1 ? Text.Parse(" as your other member[s] spurt[notS] all over the wall and her legs", parse) : "";
						Text.Add("After a while, you feel yourself approaching your limit. You push inside her as you cum, filling her [fvagDesc] with your load[mc]. You stay inside her for a moment and kiss her again, before pulling your [cockDesc] out of her [fvagDesc].", parse);
						Text.NL();
		...
		options.push({ nameStr : "Behind",
			func : function() {
				Text.Clear();
				Text.Add("As you quietly remove your [lowerArmorDesc], your [multiCockDesc] flop out. Fera stares intently at your equipment as you tell her to pull her dress up and pull down her panties. With her mound now exposed, you press against her, putting your [multiCockDesc] between her legs. You begin to push back and forth, rubbing your [multiCockDesc] against the wet lips of her [fvagDesc].", parse);
				Text.NL();
				parse["balls"] = player.HasBalls() ? Text.Parse(" and begin to drip down your [ballsDesc]", parse) : "";
				Text.Add("She purrs and pulls down her dress, presenting her [fbreastDesc] to you. Knowing what she wants, you grab her [fbreastDesc] and firmly squeeze them. The cute catgirl begins to squeeze her thighs together, increasing the stimulation on your [multiCockDesc]. Her juices coat your [multiCockDesc] as you thrust between her legs[balls].", parse);
				Text.NL();
				if(p1Cock.length.Get() >= 18)
					Text.Add("<i>“Your cock[s] [isAre] so big, [playername]...I can't wait anymore...”</i> Fera moans needily. ", parse);
				Text.Add("You kiss Fera deeply and pull your [multiCockDesc] out from between her legs. Turning her around, you tell her to lean against the wall and spread her legs.", parse);
				Text.NL();
				if(fera.flags["Behind"] >= 3) {
					Text.Add("Fera spreads her legs eagerly for you, leaning against the wall of the dressing room. She shakes her hips, inviting your [multiCockDesc] inside. From this angle, you can easily see her juices dripping from her [fvagDesc] and down her legs. You walk over to her and playfully ask what she wants, your hand patting her exposed [fbuttDesc].", parse);
					Text.NL();
					...
					Text.Add("You reward her begging by thrusting hard, smacking her ass with each thrust. She purrs and moans as she begins to thrust back at you passionately. Fera takes one hand off the wall and begins to fondle one of her [fbreastDesc], as you increase the speed of your thrusts. Her juices are now flowing out and down your [cockDesc][balls].", parse);
				}
				else {
					Text.Add("<i>“Okay...”</i> she says as she presses her hands against the wall. As she spreads her legs, you can see her [fvagDesc] glistening with her juices. Not wanting to keep her waiting, you press your [cockDesc] against her opening and push inside. She purrs softly and her tail swishes from side to side in excitement.", parse);
					Text.NL();
				...
				if(player.NumCocks() === 0) {
						...
						Text.NL();
						Text.Add("You wrap your hands around her slender frame and press your [cockDesc] deep into her [fvagDesc] as she cums around you.", parse);
						Text.NL();
						Text.Add("Your [cockDesc] slides out of her as she slumps against the wall breathing in short gasps. <i>“[playername] that was incredible!”</i>, she exhales, <i>“I may get addicted at this rate...”</i>", parse);
						Text.Add("When has regained her composure, she rises shakily to her feet, tosses you your [lowerArmorDesc], and begins to get dressed. You help her fix her dress, give her a kiss, and follow her out to the main area of the store.", parse);
				}
				else {
					if(player.CumOutput() > 3) {
						Text.Add("With the intense stimulation of her tunnel, you can't help but near orgasm. With one final thrust, you push your [cockDesc] deep into the cute catgirl's warm depths. As you cum, your [cockDesc] fills her [fvagDesc] with your seed", parse);
						if(player.NumCocks() > 1)
							Text.Add(" as your other member[s] spurt[notS] all over the floor and walls, making a huge, sticky mess", parse);
						Text.Add(". She purrs as your cum begins to leak out of her [fvagDesc] and down her legs and the length of your [cockDesc].", parse);
						Text.NL();
						Text.Add("You pull your [cockDesc] out of her with a loud slurping sound and a wad of your spunk gushes out of her, splattering on the floor. Spent, you sit on the bench for a moment, feeling her rough tongue on your [multiCockDesc][balls]. She purrs in pleasure as she diligently licks up your cum, careful not to waste a single drop.", parse);
						Text.NL();
						Text.Add("When she is finished, she reaches under the bench to grab a rag and tosses you your [lowerArmorDesc]. She wipes up the mess as you get dressed. You help her fix her dress, give her a kiss, and follow her out.", parse);
					}
					else {
						Text.Add("It doesn't take long until you feel you are about to cum, and you thrust firmly into her [fvagDesc]. Your [multiCockDesc] erupt[notS], filling her hungry snatch with your spunk", parse);
						if(player.NumCocks() > 1)
							Text.Add(" as your other prick[s] spurt[notS] onto the floor", parse);
						Text.Add(". She mewls softly as you pull out your [cockDesc], greedily wanting more.", parse);
						Text.NL();
						Text.Add("A little of your seed leaks out of her [fvagDesc] and she kneels to lovingly clean your [multiCockDesc][balls] with her tongue. After she is finished, you help her fix her dress and grab your [lowerArmorDesc]. You get dressed as she grabs a rag to clean up. Before you leave you give the cute catgirl a hug and you leave the dressing room together.", parse);
						Text.NL();
					}
				}
				Text.Flush();
		...
		if(fera.relation.Get() > 25)
		{
			options.push({ nameStr : "Anal",
				func : function() {
					...
					Text.Clear();
					Text.Add("You order Fera to lift up her dress and take off her panties. Meanwhile, you take off your [lowerArmorDesc], letting your [multiCockDesc][balls] hang free. She watches you unabashedly, waiting to hear what you have planned. Pressing her tightly against you, you reach around and grab her ass firmly. You tell her you are going to fuck her [fanusDesc].", parse);
					Text.NL();
					Text.Add("Purring softly, she looks into your [eyeDesc]s, her gaze filled with lust. Kneeling down, she licks your [cockDesc] passionately, the long strokes of her tongue thoroughly coating it in her saliva.", parse);
					Text.NL();
					...
					if(fera.Butt().virgin) {
						...
						Text.NL();
						Text.Add("You stick in one of your fingers slowly, probing her [fanusDesc]. As you stick in your second finger, she tightens up and squeezes. You move your fingers in and out a few times, spreading her [fanusDesc] wide with them. She lets out a quiet moan as you pull them out, readying your [cockDesc].", parse);
						Text.NL();
						Text.Add("You press the tip against her [fanusDesc], and push in firmly. She gasps quietly, and you can hear her breathing heavily. Her [fanusDesc] is warm and very tight, almost too much so, as you struggle to move inside her. You tell her to relax, but it does little good. You do the best you can and make short thrusts, the tightness and warmth giving you most of the pleasure.", parse);
						Text.NL();
						...
						Text.NL();
						Text.Add("<i>“Just put it in already... don't tease me like this...”</i> she whines quietly. Eager to satisfy her request, you push inside her [fanusDesc] and are soon as deep as you can get.", parse);
						Text.NL();
						...
						Text.Add("She quickly stands back up and eagerly leans against the wall, spreading her legs wide. Her tail swishes back and forth in excitement as you press the tip of your [cockDesc] against her [fanusDesc]. You push in forcefully, and she easily takes your entire length. Her experience with anal sex shows, as her passage accommodates you much more easily now.", parse);
						Text.NL();
						
						player.Fuck(p1Cock, 3);
						
						Text.Add("Her [fanusDesc] is still tight and warm, but loose enough for you to move easily. Taking advantage of her obvious desire, you pound her hard and fast, and are rewarded by her desperate moans growing louder.", parse);
						Text.NL();
						Text.Add("<i>“Yes...”</i> she whispers, panting, <i>“more...”</i> As enjoyable as this is, you decide to make things more interesting. Grabbing hold of her tail, you give it a firm tug, causing her [fanusDesc] to clamp down hard on your [cockDesc], as a startled mew escapes from her mouth. Despite any pain from you tugging on her tail, the catgirl seems to enjoy it immensely, and pants heavily.", parse);
						Text.NL();
						Text.Add("You thrust harder and harder into her tight ass, doing your best to please you both.", parse);
						if(player.HasBalls())
							Text.Add(" As you roughly pound her, your [ballsDesc] repeatedly smack against her [fvagDesc], sending shivers of pleasure through her.", parse);
					...
					if(player.NumCocks() === 0) {
						Text.Add("As she nears orgasm, you thrust deep inside her [fanusDesc], bottoming out. she climaxes, and her shaking body slides off your [cockDesc].", parse);
						Text.NL();
						...
						if(player.CumOutput() > 3) {
							Text.Add("After a while, you near your limit and push your [cockDesc] inside her with a forceful thrust. Your feel your [multiCockDesc][notS] twitch violently as you climax. She mewls loudly as you fill her ass with your seed", parse);
							if(player.NumCocks() > 1)
								Text.Add(" while your other cock[s] splatter[notS] the wall with your cum", parse);
							Text.Add(". Soon, however, her [fanusDesc] starts to overflow, and your cum spills out of her [fanusDesc]. Some drips down your [cockDesc], but much ends up on the floor.", parse);
							Text.NL();
							Text.Add("You pull out of her ass, unplugging her, and a wave of your spunk flows out of her between her legs as she happily kneels in front of you and licks your [multiCockDesc][balls] clean. When you are clean, she gets a large rag from the pile underneath the bench and wipes up the mess. You help each other get dressed and quickly kiss before leaving.", parse);
						}
						else {
							Text.Add("As you near your orgasm, thrusting deep inside her [fanusDesc], bottoming out. You climax, and fill her ass with your seed", parse);
							if(player.NumCocks() > 1)
							...
							Text.NL();
							Text.Add("She licks any remaining cum off of your [multiCockDesc][balls], and grabs a rag to clean up. After helping each other get dressed you kiss before walking out into the store.", parse);
						}
					}
					Text.Flush();
					fera.flags["Anal"]++;
		...
		if(fera.relation.Get() > 30) {
			options.push({ nameStr : "Sitting",
				func : function() {
					Text.Clear();
					Text.Add("You sit down on the small bench and take off your [lowerArmorDesc], showing off your [multiCockDesc][balls]. Fera waits impatiently in front of you, one of her hands pressing against her dress to massage her [fbreastDesc], while the other snakes inside her skirt, playing coyly with her nethers. She stares at you, a desperate look of lust in her eyes as she rubs herself.", parse);
					Text.NL();
					...
					Text.NL();
					Text.Add("Watching her toy with herself is quite arousing and you begin to feel heat coursing through your body. Feeling your restraint eroding, you tell her that she's done enough, and that as a reward for being so good, she gets to put it in herself. Fera's big blue eyes light up as she pulls down the top of her dress, exposing her [fbreastDesc]. She stands up and hurries over to you, hurriedly exposing her lower body.", parse);
					Text.NL();
					Text.Add("Fera jumps into your lap, kissing you roughly while rubbing your [multiCockDesc] with her [fvagDesc]. You can feel her warm, wet lips through her soaked panties as she rubs back and forth against you. The catgirl's juices have completely stained her white silk panties and are running down both of her legs. Her soft [fbreastDesc] press against your [breastDesc], and you feel her stiff [fnipsDesc] push against you.", parse);
					Text.NL();
					Text.Add("As she squeezes you tighter, you feel her juices thoroughly coating your [multiCockDesc] even through her panties", parse);
					if(player.HasBalls())
						Text.Add(", and dripping down your [ballsDesc] onto the bench", parse);
					Text.Add(". After a little while, she stops, and lifts herself up while grabbing[oneof] your [multiCockDesc]. She uses the head of your [cockDesc] to push her wet panties aside and puts the tip into her [fvagDesc]. With the obstruction gone, Fera sits back down, shoving your entire length inside her [fvagDesc] in one motion.", parse);
					Text.NL();
					
					player.Fuck(p1Cock, 3);
					
					Text.Add("The initial sensation is intense, and her snatch feels warmer and wetter than usual. She looks into your [eyeDesc]s, kissing you deeply as she begins to bounce in your lap.", parse);
					Text.NL();
					if(p1Cock.length.Get() >= 18) {
						Text.Add("<i>“Oh, [playername]... it's so big... it's wonderful...”</i> Fera moans as she squeezes around your [cockDesc].", parse);
						Text.NL();
					}
					...
					if(player.NumCocks() === 0) {
						Text.Add("You squeeze her tightly as she cums, and she presses into your lap, grinding your [cockDesc] deep inside her [fvagDesc]. ", parse);
							...
							Text.NL();
							Text.Add("Once you're clean, you grab a rag and help her clean up, grabbing your [lowerArmorDesc][toparmor]. After helping each other get dressed, you hug the cute catgirl tightly. <i>“Come visit again soon, [playername],”</i> she tells you as you leave the dressing room with her.", parse);
					}
					else {
						if(player.CumOutput() > 3) {
							Text.Add("You moan as your [multiCockDesc] begin[notS] to spurt [itsTheir] load[s]. Feeling your release, Fera presses down hard to take as much of you inside her as she can,", parse);
							if(player.NumCocks() > 1) {
								parse["s"]        = player.NumCocks() > 2 ? "s" : "";
								parse["notS"]     = player.NumCocks() > 2 ? "" : "s";
							...
							Text.NL();
							Text.Add("You hold her close and kiss her roughly as your excess seed begins to leak out of her and onto both your legs. <i>“I love you so much [playername]...”</i> she whispers softly. Squeezing her tight, you tell her that you love her too. You see tears in her eyes as she gets up.", parse);
							Text.NL();
							Text.Add("As she stands, your [cockDesc] slides out of her with a loud slurping sound. A combined steam of your spunk and her juices flow out of her [fvagDesc] and add to the mess already on the floor. She kneels down and leans in to lick your [multiCockDesc][balls] clean as always. Once you're clean, and she's licked up the stray strands of cum from her lips, you reach under the bench and throw her one of the larger rags, taking another one for yourself. You clean up the floor and bench, and she helps you get your [lowerArmorDesc][toparmor] back on.", parse);
							Text.NL();
