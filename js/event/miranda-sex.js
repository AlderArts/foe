...
Scenes.Miranda.HomeDommySexFuckDobieAss = function(cocks) {
	...
	parse["balls"] = player.HasBalls() ? Text.Parse(" as your [balls] slap against hers", parse) : "";
