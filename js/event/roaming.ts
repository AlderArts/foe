...
RoamingScenes.KingdomPatrol = (entering: boolean) => {
...
RoamingScenes.BanditsGen = (capt: Entity, levelbonus: number) => {
	const CreateBandit = () => {
