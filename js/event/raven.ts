...
RavenMotherScenes.TheHunt = (func: any) => {
...
RavenMotherScenes.TheHuntGlade = () => {
	const ravenmother = GAME().ravenmother;
...
RavenMotherScenes.TheHuntQuestions = (back: any) => {
	const parse: any = {
...
RavenMotherScenes.RavenPrompt = (back: any) => {
	const ravenmother = GAME().ravenmother;
