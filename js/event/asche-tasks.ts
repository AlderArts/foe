	...
	export namespace Nightshade {
		...
		export function HerbComplications() {
			...
			if (player.HasWings()) {
				...
				const goal = 60; // #make a combined stamina, dex and int check here. Maybe sum the three, make an average, and go for a check that’s suitable for a level 7 or 8 character?
